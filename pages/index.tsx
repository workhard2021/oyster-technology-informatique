...
const Entreprise=({presentation}:any)=>{
      ...
      return (<div className='relative w-full mb-[35px] flex justify-between flex-wrap'>
...
Entreprise.defaultProps={
  presentation:{
     title:'Fondé en 2016, Maestis mobilise aujourd’hui plus de 60 consultants, aux compétences pluridisciplinaires, pour accompagner ses clients dans la réflexion stratégique et pour définir une méthode d’exécution pilotée par la valeur.',
     slug:'/notre-adn',
     name:'Notre mission',
