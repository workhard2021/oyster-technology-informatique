...
export const getServerSideProps: GetServerSideProps = async (context) => {
    ...
    const arrayData=[
        {   slug:'telecom',
            ...
            list_title_3:'L’accompagnement Maestis repose sur une approche pragmatique et sur mesure permettant ainsi d’opérer une transition à l’agilité pérenne et alignée à vos valeurs',
            list_description:[
            ...
            title_description_2:'Maestis accompagne les organisations sur l’ensemble des dimensions d’une transformation Agile',
            list_description_2:[
