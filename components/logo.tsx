export const LogoSection=({data}:any)=>{
    return (<div className="w-full z-0  relative mb-16">
           <div className="w-full md:h-[700px] h-[400px] bg-url" style={{backgroundImage:`url(${data.image})`}}>
           ...
           <p className="px-6 md:absolute md:bottom-24 md:left-16 relative bottom-0 left-0 md:py-0 py-8 md:w-[35%] w-full md:text-gray-200 text-gray-400 text-xl font-lihgt">{data.description}</p>
    </div>)
}
