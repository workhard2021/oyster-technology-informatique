...
export const LogoSection=({data}:any)=>{
    ...
    return (<div className="w-full relative mb-4">
           ...
           <p style={{fontWeight:'600'}} className="mt-[65px] px-6 md:absolute md:bottom-24 md:left-16 relative bottom-0 left-0 md:py-0 leading-snug md:w-[30%] w-full text-[25px] md:text-[#fbf9f9] text-[#808080]">
