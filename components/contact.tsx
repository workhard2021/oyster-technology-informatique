     ...
     return (<div className="w-full my-8 h-auto z-0 bg-white flex justify-center flex-wrap">
         ...
         <div className="w-full h-aut p-4 flex justify-center flex-wrap">
             ...
             <div className="md:w-[45%] w-full md:px-12 px-auto md:my-16 my-8">
                ...
                <p className="font-bolder py-2 font-medium text-gray-500">Le texte généré est du pseudo latin et peut donner l&lsquo;impression d&lsquo;être du vrai texte</p>
                ...
                {/* <div className="w-full flew justify-center items-center">
                  <Link href="/">
                         <BsFacebook className="inline-block m-2 text-blue-900" size={25}/>
                  </Link>
                  <Link href="/">
                         <BsLinkedin className="inline-block m-2 text-blue-900" size={25}/>
                  </Link>
                  <Link href="/">
                         <BsTwitter className="inline-block m-2 text-blue-900" size={25}/>
                  </Link>
                  <Link href="/">
                         <SiYoutubestudio className="inline-block m-2 text-blue-900" size={25}/>
                  </Link>
                </div> */}
             </div>
         </div>
          ...
          <div className="relative py-8 w-full flex justify-center items-center flex-wrap">
              ...
              <div className="m-2 z-10 md:h-[230px] h-[240px] w-[44%] p-2 break-all md:w-[230px] bg-white text-center shadow-lg rounded-md flex items-center justify-center flex-wrap">
                <div className="m-auto">
                      <HiOutlineLocationMarker size={40} className="inline-block text-blue-900"/>
              ...
              <div className="m-2 z-10 md:h-[230px] h-[240px] w-[44%] p-2 break-all md:w-[230px] bg-white text-center shadow-lg rounded-md flex items-center justify-center flex-wrap">
                <div className="m-auto">
                      <BsTelephone size={40} className="inline-block text-blue-900"/>
              ...
              {/* <div className="m-2 z-10 md:h-[230px] h-[240px] w-[44%] p-2 break-all md:w-[230px] bg-white text-center shadow-lg rounded-md flex items-center justify-center flex-wrap">
                <div className="m-auto">
                      <FaFax size={40} className="inline-block text-blue-900"/>
              ...
              <div className="m-2 z-10 md:h-[230px] h-[240px] w-[44%] p-2 break-all md:w-[230px] bg-white text-center shadow-lg rounded-md flex items-center justify-center flex-wrap">
                <div className="m-auto">
                      <AiOutlineMail size={40} className="inline-block text-blue-900"/>
