     ...
     return (<div className="w-full my-8 h-auto z-0 bg-white flex justify-center flex-wrap">
         ...
         <div className="w-full h-aut p-4 flex justify-center flex-wrap xl:w-[70%] md:w-[90%] m-auto">
             ...
             <div className="md:w-[45%] w-full md:px-12 px-auto md:my-16 my-8">
                <div className="md:text-3xl text-2xl py-2 font-extrabold w-full text-[#122480]">Entrer en contact</div>
                <p className="font-bolder py-2 font-medium text-[#8a8a8a]">Le texte généré est du pseudo latin et peut donner l&lsquo;impression d&lsquo;être du vrai texte</p>
                <p className="py-2 text-sm text-[#8a8a8a]">Si vous aimez la photographie d&apos;art et l&apos;esprit zen, jetez un œil sur le site de ce photographe à Palaiseau, en Essonne (France).</p>
                {/* <div className="w-full flew justify-center items-center">
                  <Link href="/">
                         <BsFacebook className="inline-block m-2 text-[#122480]" size={25}/>
                  </Link>
                  <Link href="/">
                         <BsLinkedin className="inline-block m-2 text-[#122480]" size={25}/>
                  </Link>
                  <Link href="/">
                         <BsTwitter className="inline-block m-2 text-[#122480]" size={25}/>
                  </Link>
                  <Link href="/">
                         <SiYoutubestudio className="inline-block m-2 text-[#122480]" size={25}/>
                  </Link>
                </div> */}
             </div>
         </div>
          ...
          <div className="relative py-8 w-full flex justify-center items-center flex-wrap">
              ...
              {/* <div className="m-2 z-10 md:h-[230px] h-[240px] w-[44%] p-2 break-all md:w-[230px] bg-white text-center shadow-lg rounded-md flex items-center justify-center flex-wrap">
                <div className="m-auto">
                      <FaFax size={40} className="inline-block text-[#122480]"/>
                     <div className="text-md font-bold w-full py-2 text-[#122480]">Fax </div>
                     <p className="w-full text-gray-600">+212759856793</p> 
                </div>
              </div> */}
              <div className="m-2 z-10 md:h-[230px] h-[240px] w-[44%] p-2 break-all md:w-[230px] bg-white text-center shadow-lg rounded-md flex items-center justify-center flex-wrap">
