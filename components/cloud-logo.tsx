export const CloudLogo=({data,title,sub_title}:any)=>{
    return (<div className="w-full bg-gray-100 py-8">
            ...
            <div className="w-full text-center text-4xl font-bold py-2">{title}</div>
            <div className="md:w-[50%] text-sm w-full text-center text-gray-500 m-auto py-2">{sub_title}</div>
